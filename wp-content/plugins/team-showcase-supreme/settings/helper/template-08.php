<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        jQuery("#wpm_box_background").on("change", function () {
            var value = jQuery(this).val();
            jQuery("<style type='text/css'>.wpm_6310_team_style_08 { background:" + value + ";} </style>").appendTo(".wpm_6310_tabs_panel_preview");
        });
        jQuery("#wpm_member_font_hover_color").on("change", function () {
            var value = jQuery(this).val();
            jQuery("<style type='text/css'>.wpm_6310_team_style_08:hover .wpm_6310_team_style_08_title { color:" + value + ";} </style>").appendTo(".wpm-preview-box");
        });
        jQuery("#wpm_member_margin_top").on("change", function () {
            var value = jQuery(this).val() + "px";
            jQuery("<style type='text/css'>.wpm_6310_team_style_08_title { margin-top:" + value + ";} </style>").appendTo(".wpm-preview-box");
        });
        jQuery("#wpm_member_margin_bottom").on("change", function () {
            var value = jQuery(this).val() + "px";
            jQuery("<style type='text/css'>.wpm_6310_team_style_08_title { margin-bottom:" + value + ";} </style>").appendTo(".wpm-preview-box");
        });
        jQuery("#wpm_designation_margin_top").on("change", function () {
            var value = jQuery(this).val() + "px";
            jQuery("<style type='text/css'>.wpm_6310_team_style_08_designation { margin-top:" + value + ";} </style>").appendTo(".wpm-preview-box");
        });
        jQuery("#wpm_designation_margin_bottom").on("change", function () {
            var value = jQuery(this).val() + "px";
            jQuery("<style type='text/css'>.wpm_6310_team_style_08_designation { margin-bottom:" + value + ";} </style>").appendTo(".wpm-preview-box");
        });
        <?php
        ...
        jQuery("#member_stoke_1_color").on("change", function () {
            var value = jQuery(this).val();
            jQuery("<style type='text/css'> .wpm_6310_team_style_08_border { border-bottom: 3px solid " + value + ";} </style>").appendTo(".wpm-preview-box");
        });
        jQuery("#member_stoke_2_color").on("change", function () {
            var value = jQuery(this).val();
            jQuery("<style type='text/css'> .wpm_6310_team_style_08_border:after { border-bottom: 3px solid " + value + ";} </style>").appendTo(".wpm-preview-box");
        });
        jQuery("#member_stoke_1_hover_color").on("change", function () {
            var value = jQuery(this).val();
            jQuery("<style type='text/css'> .wpm_6310_team_style_08:hover .wpm_6310_team_style_08_border { border-bottom: 3px solid " + value + ";} </style>").appendTo(".wpm-preview-box");
        });
        jQuery("#member_stoke_2_hover_color").on("change", function () {
            var value = jQuery(this).val();
            jQuery("<style type='text/css'> .wpm_6310_team_style_08:hover .wpm_6310_team_style_08_border:after { border-bottom: 3px solid " + value + ";} </style>").appendTo(".wpm-preview-box");
        });
    });
</script>

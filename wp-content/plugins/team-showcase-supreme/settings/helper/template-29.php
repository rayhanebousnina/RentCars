<script type="text/javascript">
    jQuery(document).ready(function () { 
        ...
        jQuery("#wpm_image_hover_background").on("change", function () {
            ...
            alert("Change Hoise");
            // jQuery("<style type='text/css'> .wpm_6310_team_style_29_pic:before { box-shadow: 0 0 0 0 " + color + "; -moz-box-shadow: 0 0 0 0 " + color + "; -webkit-box-shadow: 0 0 0 0 " + color + "; -ms-box-shadow: 0 0 0 0 " + color + "; -o-box-shadow: 0 0 0 0 " + color + ";} </style>").appendTo(".wpm-preview-box");
            // jQuery("<style type='text/css'> .wpm_6310_team_style_29:hover .wpm_6310_team_style_29_pic:before { box-shadow: 0 0 0 400px " + color + "; -moz-box-shadow: 0 0 0 400px " + color + "; -webkit-box-shadow: 0 0 0 400px " + color + "; -ms-box-shadow: 0 0 0 400px " + color + "; -o-box-shadow: 0 0 0 400px " + color + ";} </style>").appendTo(".wpm-preview-box");
            jQuery("<style type='text/css'> .wpm_6310_team_style_29_pic:before { background: " + color + ";} </style>").appendTo(".wpm-preview-box");

                    ...
                    <div class="wpm-tab-content">
                        <div id="tab-1">
                          ...
                          <div class="wpm-6310-pro">*Preview-on-change  not available</div>
                                        ...
                                        <tr height="45">
                                            <td width="55%"><b>Image Hover Overlay Color</b>
                                            <span class="wpm-6310-pro">(Pro) <div class='wpm-6310-pro-text'>This feature is available on the pro version only.</div></span>
                                            <?php                                                                         
                                                                                            ?></td>
                                            <td>
                                    ...
                                    <table class="table table-responsive wpm_6310_admin_table">
                                        <tr height="45">
                                            <td width="55%">
                                                ...
                                                <div class='wpm-6310-pro-text'>This feature is available on the pro version only.</div></span><br />
                                            </td>
                                            <td>
                    ...
                    if ($members) {
                        ...
                        foreach ($members as $value) {
                            if ($value['profile_details_type'] == 1) {
                                $link_type = " class='wpm_6310_team_style_18 wpm_6310_team_member_info' link-id='{$value['id']}' link-url='".wpm_6310_validate_profile_url($value['profile_url'])."' target='{$value['open_new_tab']}' team-id='0'";
                            } else if ($value['profile_details_type'] == 2) {
                                $link_type = " class='wpm_6310_team_style_18 wpm_6310_team_member_info' link-id='0' team-id='{$value['id']}'";
                            } else {
